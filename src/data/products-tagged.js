...
export const products = [
  ...
  },
  {
    ...
    "description": "<p>Visa's Electronic Journal (EJ) mandate is no longer optional — every terminal needs a compliant way to capture, store, and produce EJ records. Switch supports three paths:</p>\n<ul>\n<li><strong>Option 1 — Terminal sends EJ directly.</strong> Full compliance, and the records support representments and dispute evidence. Needs a site visit or service call per terminal. <strong>$0.0006 per record per month, retained 60 months.</strong></li>\n<li><strong>Option 2 — Switch generates it.</strong> For terminals that can't send EJ themselves. No site visit — terminals opt in automatically. Full compliance for Visa reporting, but the generated records can't be used for representments or dispute processing. <strong>$0.0006 per transaction per month, retained 60 months.</strong></li>\n<li><strong>Option 3 — They manage it independently</strong> with their own tooling (GenRMS, MoniView, or similar). <strong>No Switch fee</strong>, but full compliance responsibility is theirs. If Visa requests records they can't produce, Switch may have to step in — a substantial one-time service fee can apply (pricing still under review) — and the terminal could be suspended or the merchant relationship terminated.</li>\n</ul>\n<p><strong>Combinations:</strong> 1+2 and 1+3 can run together on one portfolio. 2+3 cannot — compliance responsibility can't be split between Switch-generated and ISO-managed records.</p>\n<p>Once records are flowing, our cloud-based Dispute Dashboard automates tracking, evidence submission, and resolution.</p>\n<p><a target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-[#0a7cff] underline hover:text-[#0951fa]\" href=\"https://www.switchcommerce.com/ejfaq\">FAQs</a>&nbsp;&nbsp;&nbsp;•&nbsp;&nbsp;&nbsp;<a target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-[#0a7cff] underline hover:text-[#0951fa]\" href=\"https://usa.visa.com/content/dam/VCOM/download/about-visa/visa-rules-public.pdf\">Visa Rules</a></p>",
    ...
    "plan": "The mandate is not optional — the first question is which of the three paths fits their terminal fleet.",
