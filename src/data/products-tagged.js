...
export const products = [
  ...
  },
  {
    "company": "Clear Choice",
    "title": "Watchdog",
    "description": "When it comes to payment security, ?good enough? isn?t good enough. That?s why Watchdog combines terminal management and secure communications into one powerful solution?keeping your business protected at every layer.\n\nOur security is rooted in the same operationally secure environment you?ve always trusted to protect sensitive card data. We start at the highest standard?and then take it further.\n\nWatchdog safeguards your business with:\n? Active monitoring that detects and stops threats before they cause damage.\n? End-to-end protection ? Security built into both terminal management and communications.\n? Hardened firewalls & penetration testing proven against real-world hackers.\n\nWith Watchdog, you don?t just get protection?you get confidence that your payments are safe today and ready for tomorrow.\n\n?\n\nTop 3 Takeaways for Customers\n1) End-to-end protection ? Security built into both terminal management and communications.\n2) Trusted environment ? The same secure foundation that?s been protecting card numbers for years.\n3) Proactive defense ? Real-time monitoring, firewalls, and hacker-tested safeguards.",
