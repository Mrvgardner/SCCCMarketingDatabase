...
export const products = [
  ...
  },
  {
    ...
    "plan": "<p>The mandate is not optional, so the first question is which path fits their terminal fleet — Option 1 for terminals that can send EJ records directly, Option 2 for the ones that can't, Option 3 if they already run their own capture tool (GenRMS, MoniView, or similar). Options 1+2 and 1+3 can run together; 2+3 cannot, since compliance responsibility can't be split between Switch-generated and ISO-managed records.<br><br>Once records are flowing, our cloud-based Dispute Dashboard automates tracking, evidence submission, and resolution.<br><br><a target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-[#0a7cff] underline hover:text-[#0951fa]\" href=\"https://www.switchcommerce.com/ejfaq\">FAQs</a>&nbsp;&nbsp;&nbsp;•&nbsp;&nbsp;&nbsp;<a target=\"_blank\" rel=\"noopener noreferrer\" class=\"text-[#0a7cff] underline hover:text-[#0951fa]\" href=\"https://usa.visa.com/content/dam/VCOM/download/about-visa/visa-rules-public.pdf\">Visa Rules</a></p>",
